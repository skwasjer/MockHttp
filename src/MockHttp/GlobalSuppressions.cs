...
[assembly: System.Diagnostics.CodeAnalysis.SuppressMessage("Design", "CA1054:Uri parameters should not be strings", Justification = "By design: URIs can contain wildcards, not matching strict URI format.", Scope = "member", Target = "~M:MockHttp.RequestMatchingExtensions.RequestUri(MockHttp.RequestMatching,System.String)~MockHttp.RequestMatching")]
...
[assembly: System.Diagnostics.CodeAnalysis.SuppressMessage("Design", "CA1054:Uri parameters should not be strings", Justification = "Not an URI/URL", Scope = "member", Target = "~M:MockHttp.Matchers.FormDataMatcher.#ctor(System.String)")]
[assembly: System.Diagnostics.CodeAnalysis.SuppressMessage("Design", "CA1054:Uri parameters should not be strings", Justification = "Not an URI/URL", Scope = "member", Target = "~M:MockHttp.RequestMatchingExtensions.FormData(MockHttp.RequestMatching,System.String)~MockHttp.RequestMatching")]
[assembly: System.Diagnostics.CodeAnalysis.SuppressMessage("Globalization", "CA1303:Do not pass literals as localized parameters", Justification = "Temp disable, fix globalization later.")]
